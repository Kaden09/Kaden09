...
### Frontend:
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,sass,redux,react,nextjs,tailwind)](https://skillicons.dev)

### Backend:
[![My Skills](https://skillicons.dev/icons?i=java,spring,prisma,hibernate,kafka,redis,postgres)](https://skillicons.dev)

### Tools and DevOps:
[![My Skills](https://skillicons.dev/icons?i=docker,kubernetes,maven,yarn,pnpm,vite,github,git,bun,linux,postman,prometheus,grafana,figma,npm,photoshop,vscode,idea)](https://skillicons.dev)
