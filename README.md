...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,react,redux,nextjs,tailwind,sass,figma,git,npm,yarn,postman,vite,bun,java,spring,prisma,postgres,hibernate,express,linux,grafana,kafka,kubernetes,docker,redis,prometheus)](https://skillicons.dev)
